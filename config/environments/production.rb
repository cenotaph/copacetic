Rails.application.configure do
  ...
  config.action_mailer.default_options = {from: 'copacetic@copacetic.biz' , host: 'copaceticcomics.com'}
  
  config.action_mailer.default_url_options = {from: 'copacetic@copacetic.biz' , host: 'copaceticcomics.com'}
